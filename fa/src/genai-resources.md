...
- [Become an LLM Engineer](https://www.educative.io/path/become-an-llm-engineer) — مسیر مهارتی گسترده‌تر برای ساخت اپلیکیشن‌های عملی LLM.

### RAG و سیستم‌های production

- [Build a RAG System with LangChain](https://www.educative.io/courses/rag-llm) — پایپ‌لاین سرتاسری RAG شامل embedding، ذخیره‌سازی برداری، تولید و بهینه‌سازی.
...
- [Grokking the Generative AI System Design](https://www.educative.io/courses/generative-ai-system-design) — طراحی سیستم برای تولید متن، تصویر، گفتار و ویدئو؛ شامل آموزش، inference، scaling و ارزیابی.
- [Grokking the Machine Learning Interview](https://www.educative.io/courses/grokking-the-machine-learning-interview) — مرور مفاهیم عملی ML و مطالعه‌های موردی سرتاسری برای مصاحبه.
- [Grokking the Machine Learning System Design Interview](https://www.educative.io/courses/grokking-the-machine-learning-system-design-interview) — روش ساختاریافتهٔ حل مسئله، trade-offهای production و مصاحبه‌های آزمایشی طراحی سیستم ML.
